...
class Visualizer:
    def __init__(
        ...
        self.r_sim_all = np.ndarray((N_sim + 1, nr))
    ...
    def update(self, i, x, r, u):
        self.x_sim_all[i + 1, :] = x    # Next time step
        self.r_sim_all[i + 1, :] = r    # Next time step
    ...
    def visualize(
        ...
        plt.plot(time_data_x, x_sim_all[:self.data_idx, 0], 'r', label="x")
        plt.plot(time_data_x, x_sim_all[:self.data_idx, 1], 'g', label="y")
        plt.plot(time_data_x, x_sim_all[:self.data_idx, 2], 'b', label="z")
        if self.is_reference:
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 0], 'r--', label="xr")
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 1], 'g--', label="yr")
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 2], 'b--', label="zr")
        ...
        plt.plot(time_data_x, euler[:self.data_idx, 0], 'gold', label="roll")
        ...
        # if self.is_reference:
        #     plt.plot(time_data_x, r_sim_all[:self.data_idx, 6], 'c--', label="joint1r")
        #     plt.plot(time_data_x, r_sim_all[:self.data_idx, 7], 'm--', label="joint2r")
        #     plt.plot(time_data_x, r_sim_all[:self.data_idx, 8], 'y--', label="joint3r")
        plt.legend(framealpha=legend_alpha)
        plt.xlabel("Time (s)")
        plt.xlim([0, t_total_sim])
        ...
        plt.plot(time_data_x, r_sim_all[:self.data_idx, 6], 'c', label="fx")
        plt.plot(time_data_x, r_sim_all[:self.data_idx, 7], 'm', label="fy")
        plt.plot(time_data_x, r_sim_all[:self.data_idx, 8], 'y', label="fz")
        plt.legend(framealpha=legend_alpha)
        plt.xlabel("Time (s)")
        plt.xlim([0, t_total_sim])
        ...
        plt.plot(time_data_x, r_sim_all[:self.data_idx, 9], 'c', label="tx")
        plt.plot(time_data_x, r_sim_all[:self.data_idx, 10], 'm', label="ty")
        plt.plot(time_data_x, r_sim_all[:self.data_idx, 11], 'y', label="tz")
        plt.legend(framealpha=legend_alpha)
        plt.xlabel("Time (s)")
        plt.xlim([0, t_total_sim])
        ...
        if self.include_cog_dist_model:
            ...
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 12], 'c--', label="fx_est")
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 13], 'm--', label="fy_est")
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 14], 'y--', label="fz_est")
            plt.legend(framealpha=legend_alpha, loc="upper left")
            plt.xlim([0, t_total_sim])
            ...
            # else:
            #     plt.subplot(ceil(n_plots/2), 2, 10)
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 15], 'c--', label="tx_est")
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 16], 'm--', label="ty_est")
            plt.plot(time_data_x, r_sim_all[:self.data_idx, 17], 'y--', label="tz_est")
            plt.legend(framealpha=legend_alpha, loc="upper left")
            plt.xlim([0, t_total_sim])
